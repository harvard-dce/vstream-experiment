// Adapted from https://github.com/nickdesaulniers/netfix/blob/gh-pages/demo/bufferAll.html.

function bufferWhenNeeded(opts) {
  var video;
  var url;
  var mimeCodec;
  ...
  function checkBuffer (_) {
    ...
    if (currentSegment === totalSegments && haveAllSegments()) {
      ...
      fetchRange(url, bytesFetched, bytesFetched + segmentLength, appendSegment);
    }
...
module.exports = bufferWhenNeeded;
